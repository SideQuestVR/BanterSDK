// Alpha-blended twin of Unlit/DiffuseTriplanar. Body lives in SQDiffuseCore.hlsl.
Shader "Unlit/DiffuseTriplanarTransparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			// Per-material optional maps, set by BSMaterial (see DiffuseTriplanar.shader).
