// World-space triplanar twin of Unlit/Diffuse: no UVs, the texture tiles every _TriplanarScale
// metres along each world axis and blends across faces. Body lives in SQDiffuseCore.hlsl.
Shader "Unlit/DiffuseTriplanar"
{
	Properties
	{
