...
namespace Lachee.IO
{
    public class NamedPipeClientStream : System.IO.Stream
    {
        ...
        /// </summary>
        /// <param name="server">The remote to connect to</param>
        /// <param name="pipeName">The name of the pipe that will be connected to.</param>
        ...
        public int Connect()
        {
            // Added return code because code can be 2 (error) even though IsConnected==true
