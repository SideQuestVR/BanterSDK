...
namespace Banter.SDK
{
    ...
    public class BSSpringJoint : UnityComponentBase
    {
        ...
        internal override void Deserialise(List<object> values)
        {
            ...
            for (int i = 0; i < values.Count; i++)
            {
                ...
                {
                    var valspring = (BSFloat)values[i];
                ...
                if (values[i] is BSFloat)
                {
                    var valdamper = (BSFloat)values[i];
                ...
                if (values[i] is BSFloat)
                {
                    var valminDistance = (BSFloat)values[i];
                ...
                if (values[i] is BSFloat)
                {
                    var valmaxDistance = (BSFloat)values[i];
                ...
                if (values[i] is BSFloat)
                {
                    var valtolerance = (BSFloat)values[i];
