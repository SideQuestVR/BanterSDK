...
namespace BS
{
    /*
    #### Banter Icosahedron
    A twenty-faced regular polyhedron.
    ...
    */
    ...
    [WatchComponent]
    public class BSIcosahedron : BSComponentBase
    {
        ...
        void SetupGeometry()
        {
            ...
            geometry.geometryType = GeometryType.IcosahedronGeometry;
        ...
        {
            return "Icosahedron" +  PropertyName.radius + radius + PropertyName.detail + detail;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.Icosahedron);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BSComponentPropertyUpdate()
                {
                    ...
                    value = radius,
                    componentType = ComponentType.Icosahedron,
                    oid = oid,
                    cid = cid
                });
            }
