...
namespace Banter.SDK
{
    ...
    [WatchComponent]
    public class BanterHorn : BanterComponentBase
    {
        ...
        void SetupGeometry()
        {
            ...
            geometry.parametricType = ParametricGeometryType.Horn;
        ...
        {
            return "BanterHorn" +  PropertyName.stacks + stacks + PropertyName.slices + slices;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.BanterHorn);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BanterComponentPropertyUpdate()
                {
                    ...
                    value = stacks,
                    componentType = ComponentType.BanterHorn,
                    oid = oid,
                    cid = cid
                });
            }
