...
namespace BS
{
    /*
    #### Banter Octahedron
    An eight-faced regular polyhedron.
    ...
    */
    ...
    [WatchComponent]
    public class BSOctahedron : BSComponentBase
    {
        ...
        void SetupGeometry()
        {
            ...
            geometry.geometryType = GeometryType.OctahedronGeometry;
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BSComponentPropertyUpdate()
                {
                    ...
                    value = radius,
                    componentType = ComponentType.Octahedron,
                    oid = oid,
                    cid = cid
                });
            }
