...
namespace BS
{
    /*
    #### Banter Tetrahedron
    A four-faced regular polyhedron.
    ...
    */
    ...
    [WatchComponent]
    public class BSTetrahedron : BSComponentBase
    {
        ...
        void SetupGeometry()
        {
            ...
            geometry.geometryType = GeometryType.TetrahedronGeometry;
        ...
        {
            return "Tetrahedron" + PropertyName.radius + radius + PropertyName.detail + detail;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.Tetrahedron);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BSComponentPropertyUpdate()
                {
                    ...
                    value = radius,
                    componentType = ComponentType.Tetrahedron,
                    oid = oid,
                    cid = cid
                });
            }
