...
namespace Banter.SDK
{
    ...
    [WatchComponent]
    public class BanterNatica : BanterComponentBase
    {
        ...
        void SetupGeometry()
        {
            ...
            geometry.parametricType = ParametricGeometryType.Natica;
        ...
        {
            return "BanterNatica" +  PropertyName.stacks + stacks + PropertyName.slices + slices;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.BanterNatica);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BanterComponentPropertyUpdate()
                {
                    ...
                    value = stacks,
                    componentType = ComponentType.BanterNatica,
                    oid = oid,
                    cid = cid
                });
            }
