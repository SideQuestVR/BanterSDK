...
namespace Banter.SDK
{
    ...
    [WatchComponent]
    public class BanterMobius : BanterComponentBase
    {
        ...
        void SetupGeometry()
        {
            ...
            geometry.parametricType = ParametricGeometryType.Mobius;
        ...
        {
            return "BanterMobius" +  PropertyName.stacks + stacks + PropertyName.slices + slices;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.BanterMobius);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BanterComponentPropertyUpdate()
                {
                    ...
                    value = stacks,
                    componentType = ComponentType.BanterMobius,
                    oid = oid,
                    cid = cid
                });
            }
