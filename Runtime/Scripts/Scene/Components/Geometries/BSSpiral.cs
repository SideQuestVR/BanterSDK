...
namespace Banter.SDK
{
    ...
    [WatchComponent]
    public class BSSpiral : BanterComponentBase
    {
        ...
        {
            return "BSSpiral" +  PropertyName.stacks + stacks + PropertyName.slices + slices;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.BSSpiral);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BanterComponentPropertyUpdate()
                {
                    ...
                    value = stacks,
                    componentType = ComponentType.BSSpiral,
                    oid = oid,
                    cid = cid
                });
            }
