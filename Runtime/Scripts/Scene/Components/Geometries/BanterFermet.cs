...
namespace Banter.SDK
{
    ...
    [WatchComponent]
    public class BanterFermet : BanterComponentBase
    {
        ...
        {
            return "BanterFermet" +  PropertyName.stacks + stacks + PropertyName.slices + slices;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.BanterFermet);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BanterComponentPropertyUpdate()
                {
                    ...
                    value = stacks,
                    componentType = ComponentType.BanterFermet,
                    oid = oid,
                    cid = cid
                });
            }
