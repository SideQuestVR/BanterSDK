...
namespace Banter.SDK
{
    ...
    [WatchComponent]
    public class BanterPillow : BanterComponentBase
    {
        ...
        void SetupGeometry()
        {
            ...
            geometry.parametricType = ParametricGeometryType.Pillow;
        ...
        {
            return "BanterPillow" +  PropertyName.stacks + stacks + PropertyName.slices + slices;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.BanterPillow);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BanterComponentPropertyUpdate()
                {
                    ...
                    value = stacks,
                    componentType = ComponentType.BanterPillow,
                    oid = oid,
                    cid = cid
                });
            }
