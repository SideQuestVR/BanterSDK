...
namespace Banter.SDK
{
    ...
    [WatchComponent]
    public class BanterScherk : BanterComponentBase
    {
        ...
        void SetupGeometry()
        {
            ...
            geometry.parametricType = ParametricGeometryType.Scherk;
        ...
        {
            return "BanterScherk" +  PropertyName.stacks + stacks + PropertyName.slices + slices;
        }
        ...
        internal override void Init(List<object> constructorProperties = null)
        {
            ...
            alreadyStarted = true;
            scene.RegisterBanterMonoscript(gameObject.GetInstanceID(), GetInstanceID(), ComponentType.BanterScherk);
        ...
        internal override void SyncProperties(bool force = false, Action callback = null)
        {
            ...
            if (force)
            {
                updates.Add(new BanterComponentPropertyUpdate()
                {
                    ...
                    value = stacks,
                    componentType = ComponentType.BanterScherk,
                    oid = oid,
                    cid = cid
                });
            }
