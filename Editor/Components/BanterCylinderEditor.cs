...
{
    [CustomEditor(typeof(BanterCylinder))]
    public class BanterCylinderEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterCylinder)
            {
                var script = (BanterCylinder)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("topRadius, bottomRadius, height, radialSegments, heightSegments, openEnded, thetaStart, thetaLength, ");
