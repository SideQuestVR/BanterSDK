...
{
    [CustomEditor(typeof(BanterPlane))]
    public class BanterPlaneEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterPlane)
            {
                var script = (BanterPlane)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("width, height, widthSegments, heightSegments, ");
