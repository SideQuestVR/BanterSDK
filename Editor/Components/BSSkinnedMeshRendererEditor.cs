...
namespace Banter.SDKEditor
{
    ...
    [CustomEditor(typeof(BSSkinnedMeshRenderer), true)]
    public class BSSkinnedMeshRendererEditor : Editor
    {
        void OnEnable()
        {
            if (target is BSSkinnedMeshRenderer)
            {
                var script = (BSSkinnedMeshRenderer)target;
