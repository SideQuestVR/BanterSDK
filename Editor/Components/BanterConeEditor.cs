...
{
    [CustomEditor(typeof(BanterCone))]
    public class BanterConeEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterCone)
            {
                var script = (BanterCone)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("radius, height, radialSegments, heightSegments, openEnded, thetaStart, thetaLength, ");
