...
{
    [CustomEditor(typeof(BanterAvatarPedestal))]
    public class BanterAvatarPedestalEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterAvatarPedestal)
            {
                var script = (BanterAvatarPedestal)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("userId, userAvatarId, authorId, ");
