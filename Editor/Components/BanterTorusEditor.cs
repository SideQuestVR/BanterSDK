...
{
    [CustomEditor(typeof(BanterTorus))]
    public class BanterTorusEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterTorus)
            {
                var script = (BanterTorus)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("radius, tube, radialSegments, tubularSegments, arc, ");
