...
namespace BS.SDKEditor
{
    ...
    [CustomEditor(typeof(BSCapsuleCollider), true)]
    public class BSCapsuleColliderEditor : Editor
    {
        void OnEnable()
        {
            if (target is BSCapsuleCollider)
            {
                var script = (BSCapsuleCollider)target;
