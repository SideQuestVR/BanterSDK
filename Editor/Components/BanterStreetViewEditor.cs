...
{
    [CustomEditor(typeof(BanterStreetView))]
    public class BanterStreetViewEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterStreetView)
            {
                var script = (BanterStreetView)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("panoId, ");
