...
{
    [CustomEditor(typeof(BanterSkinnedMeshRenderer))]
    public class BanterSkinnedMeshRendererEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterSkinnedMeshRenderer)
            {
                var script = (BanterSkinnedMeshRenderer)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("blendShapes, bones, rootBoneInstanceId, updateWhenOffscreen, skinnedMotionVectors, quality, ");
