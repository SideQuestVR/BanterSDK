...
namespace Banter.SDKEditor
{
    ...
    public class BanterSpringJointEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("anchor, connectedAnchor, autoConfigureConnectedAnchor, spring, damper, minDistance, maxDistance, tolerance, breakForce, breakTorque, enableCollision, enablePreprocessing, connectedMassScale, massScale, ");
