...
{
    [CustomEditor(typeof(BanterTorusKnot))]
    public class BanterTorusKnotEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterTorusKnot)
            {
                var script = (BanterTorusKnot)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("radius, tube, radialSegments, tubularSegments, p, q, ");
