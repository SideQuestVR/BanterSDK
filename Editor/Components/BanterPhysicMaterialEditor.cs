...
namespace Banter{
    [CustomEditor(typeof(BanterPhysicMaterial))]
    public class BanterPhysicMaterialEditor : Editor{
        void OnEnable() {
            if(target is BanterPhysicMaterial){
                var script = (BanterPhysicMaterial)target;
...
var seeFields = new Label("dynamicFriction, staticFriction, ");
