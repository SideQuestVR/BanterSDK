...
{
    [CustomEditor(typeof(BanterBox))]
    public class BanterBoxEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterBox)
            {
                var script = (BanterBox)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("width, height, depth, widthSegments, heightSegments, depthSegments, ");
