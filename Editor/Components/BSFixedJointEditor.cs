...
namespace BS.SDKEditor
{
    ...
    [CustomEditor(typeof(BSFixedJoint), true)]
    public class BSFixedJointEditor : Editor
    {
        void OnEnable()
        {
            if (target is BSFixedJoint)
            {
                var script = (BSFixedJoint)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("anchor, connectedAnchor, autoConfigureConnectedAnchor, breakForce, breakTorque, enableCollision, enablePreprocessing, connectedMassScale, massScale, connectedBody, ");
