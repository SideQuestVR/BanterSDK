...
{
    [CustomEditor(typeof(BanterBoxCollider))]
    public class BanterBoxColliderEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterBoxCollider)
            {
                var script = (BanterBoxCollider)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("isTrigger, center, size, ");
