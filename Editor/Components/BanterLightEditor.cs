...
{
    [CustomEditor(typeof(BanterLight))]
    public class BanterLightEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterLight)
            {
                var script = (BanterLight)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("type, color, intensity, range, spotAngle, innerSpotAngle, shadows, ");
