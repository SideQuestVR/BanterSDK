...
namespace Banter{
    [CustomEditor(typeof(BanterSphereCollider))]
    public class BanterSphereColliderEditor : Editor{
        void OnEnable() {
            if(target is BanterSphereCollider){
                var script = (BanterSphereCollider)target;
...
var seeFields = new Label("isTrigger, radius, ");
