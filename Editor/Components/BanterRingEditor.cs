...
{
    [CustomEditor(typeof(BanterRing))]
    public class BanterRingEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterRing)
            {
                var script = (BanterRing)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("innerRadius, outerRadius, thetaSegments, phiSegments, thetaStart, thetaLength, ");
