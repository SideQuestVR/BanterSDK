...
{
    [CustomEditor(typeof(BanterVideoPlayer))]
    public class BanterVideoPlayerEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterVideoPlayer)
            {
                var script = (BanterVideoPlayer)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("url, volume, playOnAwake, skipOnDrop, waitForFirstFrame, isPlaying, isLooping, isPrepared, isMuted, duration, ");
