...
{
    [CustomEditor(typeof(BanterGLTF))]
    public class BanterGLTFEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterGLTF)
            {
                var script = (BanterGLTF)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("url, generateMipMaps, addColliders, nonConvexColliders, slippery, climbable, legacyRotate, childrenLayer, ");
