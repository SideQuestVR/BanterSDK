...
{
    [CustomEditor(typeof(BanterBrowser))]
    public class BanterBrowserEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterBrowser)
            {
                var script = (BanterBrowser)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("url, mipMaps, pixelsPerUnit, pageWidth, pageHeight, actions, ");
