...
{
    [CustomEditor(typeof(BanterSphere))]
    public class BanterSphereEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterSphere)
            {
                var script = (BanterSphere)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("radius, widthSegments, heightSegments, phiStart, phiLength, thetaStart, thetaLength, ");
