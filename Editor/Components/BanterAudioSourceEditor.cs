...
{
    [CustomEditor(typeof(BanterAudioSource))]
    public class BanterAudioSourceEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterAudioSource)
            {
                var script = (BanterAudioSource)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("volume, pitch, mute, loop, bypassEffects, bypassListenerEffects, bypassReverbZones, playOnAwake, spatialBlend, ");
