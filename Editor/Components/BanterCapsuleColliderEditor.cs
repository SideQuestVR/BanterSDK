...
{
    [CustomEditor(typeof(BanterCapsuleCollider))]
    public class BanterCapsuleColliderEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterCapsuleCollider)
            {
                var script = (BanterCapsuleCollider)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("isTrigger, radius, height, ");
