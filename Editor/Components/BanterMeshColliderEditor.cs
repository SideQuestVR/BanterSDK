...
{
    [CustomEditor(typeof(BanterMeshCollider))]
    public class BanterMeshColliderEditor : Editor
    {
        void OnEnable()
        {
            if (target is BanterMeshCollider)
            {
                var script = (BanterMeshCollider)target;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var seeFields = new Label("convex, isTrigger, ");
