...
namespace Banter.VisualScripting
{
    ...
    [UnitTitle("On SecondaryThumbstick")]
    [UnitShortTitle("On SecondaryThumbstick")]
    [UnitCategory("Events\\Banter\\HeldEvents")]
    [TypeIcon(typeof(BanterObjectId))]
    public class OnSecondaryThumbstick : EventUnit<CustomEventArgs>
    {
        [DoNotSerialize]
        [PortLabelHidden]
        [NullMeansSelf]
        ...
        {
            return new EventHook("OnSecondaryThumbstick");
        }
